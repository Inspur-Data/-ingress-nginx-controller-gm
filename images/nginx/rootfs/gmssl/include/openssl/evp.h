...
//2023.10.10
int EVP_CIPHER_CTX_set_iv(EVP_CIPHER_CTX *ctx, unsigned char *iv, int enc);
...
const EVP_CIPHER *EVP_sm4_ofb128(void);
...
const EVP_CIPHER *EVP_sm1_ofb128(void);
#  define EVP_sm1_ofb EVP_sm1_ofb128
const EVP_CIPHER *EVP_sm1_ctr(void);
const EVP_CIPHER *EVP_sm1_gcm(void);
# endif

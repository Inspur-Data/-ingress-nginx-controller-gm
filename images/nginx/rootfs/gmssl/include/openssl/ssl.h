...
//2023.04.29
void GMSSL_checkLicense();

//2023.10.01
int SM1_Init(char* so_path, char *oem);
void SM1_Finalize();
...
//2023.03.21
typedef void (*secretCallback)(unsigned char *p, int len);
void SSL_ext_setSecretCallback(secretCallback impl);
